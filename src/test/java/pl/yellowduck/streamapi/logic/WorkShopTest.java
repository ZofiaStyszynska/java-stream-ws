...
import pl.yellowduck.streamapi.domain.Account;
import pl.yellowduck.streamapi.domain.AccountType;
import pl.yellowduck.streamapi.domain.Currency;
import pl.yellowduck.streamapi.domain.User;
...
public class WorkShopTest {
    ...
    public void shouldCalculateAmountInPln() {
        final Account accountWithOneZloty = Account.builder()
                ...
                .currency(pl.yellowduck.streamapi.domain.Currency.PLN)
                .build();
        ...
        final Account accountWithOneDolar = Account.builder()
                .amount(new BigDecimal("1.0"))
                .currency(pl.yellowduck.streamapi.domain.Currency.USD)
                .build();
    ...
    public void shouldGetTotalCashInPLNCorrectlySum() {
        final List<Account> accounts = Arrays.asList(
                Account.builder().amount(new BigDecimal(150)).currency(pl.yellowduck.streamapi.domain.Currency.PLN).build(), // 150 PLN
                Account.builder().amount(new BigDecimal(50)).currency(pl.yellowduck.streamapi.domain.Currency.USD).build(), // 186 PLN
